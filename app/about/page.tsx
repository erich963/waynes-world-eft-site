    ...
    <>
      ...
      <section className="section">
        <div className="container-content max-w-3xl">
          ...
          <div className="border-l-4 border-brand-red pl-8 mb-8">
            <p className="text-gray-900 leading-relaxed mb-3 text-xl font-medium">
            ...
            <p className="text-brand-red font-semibold text-sm uppercase tracking-widest">— Wayne Burwell</p>
          </div>
      ...
      <section className="section-accent">
        <div className="container-content text-center">
          <h2 className="section-title">Come See What We&apos;re About</h2>
